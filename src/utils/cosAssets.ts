...
export const imageAssets = {
  ...
  heJingshanId: cosAssetUrl('he-jingshan-id.png'),
  jiangMaskBackEvidence: cosAssetUrl('jiang-mask-back-evidence.png'),
  jiangMaskEvidence: cosAssetUrl('jiang-mask-evidence.png'),
  jiangMaskSurveyStage: cosAssetUrl('jiang-mask-survey-stage.png'),
